...
echo "./NNPAgent/DCAAgent/bin/DCAAgentInstall.sh 2 \$CUR_PATH R1.5.635" >> ./AgentInstall.sh
...
echo "VAgent(HAGENT) setting..."
\cp ./NNPAgent/utils/INSTALL/patch.sh_pagent ./NNPAgent/utils/INSTALL/patch.sh
./NNPAgent/utils/ETC/ConfUpdate PROCNAME=HAGENT ./NNPAgent/MAgent/conf/MasterAgent.conf > /dev/null
...
./NNPAgent/utils/ETC/ConfUpdate 4.47=1 ./NNPAgent/SMSAgent/bin/GatherStatusFile.txt > /dev/null
