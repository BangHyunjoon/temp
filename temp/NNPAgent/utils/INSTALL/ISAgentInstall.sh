...
#PARAMETER=`echo "-magent auip=166.125.19.180 makey=MA_"$NODEIP"_"$INSTALLDATE" -start -addrc"`
PARAMETER=`echo "-magent auip=10.156.26.121 makey=MA_"$NODEIP"_"$INSTALLDATE" -start -addrc"`
