...
RECVRY_HOSTNAME_NFILE1=./shell/SOLARIS/recovery/hostname_new.dat
RECVRY_HOSTNAME_NFILE2=./shell/SOLARIS/recovery/hostname_set_file_new.dat
RECVRY_HOSTNAME_OFILE1=./shell/SOLARIS/recovery/hostname_old.dat
RECVRY_HOSTNAME_OFILE2=./shell/SOLARIS/recovery/hostname_set_file_old.dat

RECVRY_HOSTNAME_DFILE1=./shell/SOLARIS/recovery/hostname_new.dat.$EXEC_DATE
RECVRY_HOSTNAME_DFILE2=./shell/SOLARIS/recovery/hostname_set_file_new.dat.$EXEC_DATE

COMMAND=`echo "" > $FILE_DAT`
COMMAND=`mkdir ./shell/SOLARIS/recovery >> $FILE_DAT 2>&1 `
...
COMMAND=`svccfg -s system/identity:node listprop config | grep config/nodename > $RECVRY_HOSTNAME_NFILE2`
