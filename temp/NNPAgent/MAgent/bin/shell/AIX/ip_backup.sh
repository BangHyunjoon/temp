...
RECVRY_SHELL=../bin/shell/AIX/recovery/ip_recovery_$1.sh
RECVRY_IP_FILE1=../bin/shell/AIX/recovery/network_mac_old_$1.dat
MAC_INFO=$1
NIC_NAME=""
if [ $1 ] ; then
    ...
    COMMAND=`echo "    CMD=\\\`./shell/AIX/ip_update.sh $* >> \\\$FILE_DAT\\\`" >> $RECVRY_SHELL`
