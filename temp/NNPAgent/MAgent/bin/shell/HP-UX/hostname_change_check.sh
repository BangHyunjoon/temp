...
RECVRY_HOSTNAME_NFILE1=./shell/HP-UX/recovery/hostname_new.dat
RECVRY_HOSTNAME_NFILE2=./shell/HP-UX/recovery/hostname_set_file_new.dat
RECVRY_HOSTNAME_OFILE1=./shell/HP-UX/recovery/hostname_old.dat
RECVRY_HOSTNAME_OFILE2=./shell/HP-UX/recovery/hostname_set_file_old.dat

RECVRY_HOSTNAME_DFILE1=./shell/HP-UX/recovery/hostname_new.dat.$EXEC_DATE
RECVRY_HOSTNAME_DFILE2=./shell/HP-UX/recovery/hostname_set_file_new.dat.$EXEC_DATE
...
COMMAND=`grep HOSTNAME= /etc/rc.config.d/netconf > $RECVRY_HOSTNAME_NFILE2`
