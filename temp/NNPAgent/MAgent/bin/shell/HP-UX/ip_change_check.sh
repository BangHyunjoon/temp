...
COMMAND=`mkdir ./shell/HP-UX/recovery >> $FILE_DAT 2>&1 `
EXEC_DATE=`date +%Y%m%d%H%M%S`
RECVRY_IP_NFILE1=./shell/HP-UX/recovery/network_mac_new_$1.dat
RECVRY_IP_NFILE2=./shell/HP-UX/recovery/netconf_file_new_$1.dat
RECVRY_IP_OFILE1=./shell/HP-UX/recovery/network_mac_old_$1.dat
RECVRY_IP_OFILE2=./shell/HP-UX/recovery/netconf_file_old_$1.dat

RECVRY_IP_DFILE1=./shell/HP-UX/recovery/network_mac_new_$1.dat.$EXEC_DATE
RECVRY_IP_DFILE2=./shell/HP-UX/recovery/netconf_file_new_$1.dat.$EXEC_DATE
...
if [ $1 ] ; then
    ...
    if [ $NIC_NAME ] ; then
        ...
        BAK_CFG_NICFILE=./shell/HP-UX/ifcfg_set_$NIC_NAME
    else
        echo "Not found interface name : [$NIC_NAME]" >> $FILE_DAT
        exit 255
    fi
    COMMAND=`cat /etc/rc.config.d/netconf > $RECVRY_IP_NFILE2`
