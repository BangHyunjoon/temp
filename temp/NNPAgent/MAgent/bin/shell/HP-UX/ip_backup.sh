...
RECVRY_SHELL=../bin/shell/HP-UX/recovery/ip_recovery_$1.sh
RECVRY_IP_FILE1=../bin/shell/HP-UX/recovery/network_mac_old_$1.dat
RECVRY_IP_FILE2=../bin/shell/HP-UX/recovery/netconf_file_old_$1.dat
MAC_INFO=$1
NIC_NAME=""
if [ $1 ] ; then
    ...
    COMMAND=`echo "    CMD=\\\`./shell/HP-UX/ip_update.sh $* >> \\\$FILE_DAT\\\`" >> $RECVRY_SHELL`
    ...
    COMMAND=`cat /etc/rc.config.d/netconf > $RECVRY_IP_FILE2`
